    ...
    <div style="width: 100%; padding-top: 20px; padding-bottom: 30px">
                ...
                <td>
                    ...
                    <table style="width: 50%">
                        <tr>
                            <td style="border: 1px solid #a0a0a0; text-align: center; width: 50%">
                                <label>Date</label>
                                <input type="text" value="{{$data->value_date}}">
                            </td>
                            <td style="border: 1px solid #a0a0a0; text-align: center; width: 50%">
                                <label>Amount (Naira)</label>
                                <input type="text" value="{{$data->total_tax->tax ?? " "}}">
                            </td>
                        </tr>
                        <tr>
                            <td>
                            ...
                            <td>
                                <table style="width: 100%">
                                    <tr>
                                        <td style="border: 1px solid #a0a0a0; text-align: center;">{{$data->total_tax->tax ?? " "}}</td>
        ...
        <table style="width: 100%; margin-top: 10px; border: 1px solid #a0a0a0">
            ...
            @foreach($data->payee_vouchers as $payee)
                ...
                <tr>
                    ...
                    <td style="text-align: center; box-shadow: 0 0 0 1px #a0a0a0">{{$payee->total_tax}}</td>
                        ...
                        <tr>
                            <td colspan="2">
                                <span class="text-bold"
                                      style="margin-left: 10px">{{$data->checking_officer->first_name}}</span>
                            </td>
                        </tr>
                        <tr>
                            <td>
                                <table style="width: 100%">
                                    <tr>
                                        ...
                                        <td style="width: 25%"
                                            class="shadow-1px">{{$data->default_setting->account_head->name ?? " "}}</td>
        ...
        <table style="width: 100%">
            <tr>
                ...
                <td style="width: 12%; text-align: center">in the full settlement of the amount</td>
                <td class="shadow-1px" style="width: 30%"></td>
            </tr>
        </table>
        <table style="width: 100%">
