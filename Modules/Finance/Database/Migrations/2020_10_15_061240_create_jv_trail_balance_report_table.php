...
class CreateJvTrailBalanceReportTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('jv_trail_balance_report', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('jv_trail_balance_report');
    }
}
