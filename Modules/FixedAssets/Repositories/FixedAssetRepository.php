...
class FixedAssetRepository extends EloquentBaseRepository
{
    ...
    public function update($data)
    {
        ...
        $depriciationDetail  =  FxaDepreciationDetail::where('fxa_assets_id',$data['id'])->first();
        if ($depriciationDetail){
            unset($data['data']['acquisition_cost']);
            unset($data['data']['salvage_value']);
            unset($data['data']['begin_accum_depr']);
        }
