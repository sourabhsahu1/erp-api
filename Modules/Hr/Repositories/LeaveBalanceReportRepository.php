...
use Modules\Hr\Models\LeaveBalanceReport;

class LeaveBalanceReportRepository extends EloquentBaseRepository
{
    public $model = LeaveBalanceReport::class;

    public function getAll($params = [], $query = null)
    {
        $query["inputs"]["created_at"] = null;
        $query = LeaveBalanceReport::query();
