...
class CreateIdNosRequest extends BaseRequest
{
    ...
    public function rules()
    {
        ...
        return [
            ...
            'pensionFundAdministration' => ["required", Rule::unique('hr_employee_id_nos', 'pension_fund_administration')->ignore($idNosId)],
            ...
            'pfaNumber' => ["required", Rule::unique('hr_employee_id_nos', 'pfa_number')->ignore($idNosId)],
